...
Book::Result Application::Run()
{
    ...
    StrAcc Txt;
    Book::Fmt::BookFmt BF;
    BF << R"( Testing  \{Colors:Yellow On Blue Icon:Success} Book\{Fg:Cyan On White}::\{Fg:Grey100}Fmt\{Fg::Cyan}::\{Fg:BlueViolet}BookFmt\{Fg:White}...\{Colors:Red,White;}Termin&eacute; !!)" >> Txt;
